...
| io.obase:providers.postgresql  | [![Maven central](https://maven-badges.sml.io/sonatype-central/io.obase/providers.postgresql/badge.svg)](https://maven-badges.sml.io/sonatype-central/io.obase/providers.postgresql) | 适用于SqlServer数据库的Obase存储提供程序中间件. |
