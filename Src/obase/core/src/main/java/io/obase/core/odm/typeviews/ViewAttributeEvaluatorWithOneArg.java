 ...
 * 有一个源的视图属性的求值器
 *
 * @param <TAgent> 第一个源的代理属性的类型
 */
public class ViewAttributeEvaluatorWithOneArg<TAgent> extends ViewAttributeEvaluator {
     ...
     */
    public ViewAttributeEvaluatorWithOneArg(LambdaExpression lambdaExpression) {
    ...
    public Object evaluate(Object[] agentValues) {
        return this.lambdaExpression.compile().invoke(new Object[]{agentValues[0]});
    }
}
