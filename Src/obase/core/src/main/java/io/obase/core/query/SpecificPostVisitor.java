...
public class SpecificPostVisitor {
     ...
     * @return 代表后置访问逻辑的委托
     */
    public IPostVisit getPostVisit() {
     ...
     */
    public void setPostVisit(IPostVisit postVisit) {
