 ...
 */
public class ViewAttributeEvaluatorWithTwoArgs<TAgent1, TAgent2> extends ViewAttributeEvaluator {
     ...
     */
    public ViewAttributeEvaluatorWithTwoArgs(LambdaExpression lambdaExpression) {
    ...
    public Object evaluate(Object[] agentValues) {
        return this.lambdaExpression.compile().invoke(new Object[]{agentValues[0], agentValues[1]});
    }
}
