 ...
 */
public class ViewAttributeEvaluatorWithThreeArgs<TAgent1, TAgent2, TAgent3> extends ViewAttributeEvaluator {
     ...
     */
    public ViewAttributeEvaluatorWithThreeArgs(LambdaExpression lambdaExpression) {
    ...
    public Object evaluate(Object[] agentValues) {
        return this.lambdaExpression.compile().invoke(new Object[]{agentValues[0], agentValues[1], agentValues[2]});
    }
}
