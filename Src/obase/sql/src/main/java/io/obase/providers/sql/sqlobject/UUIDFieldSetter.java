 ...
 * UUID字段设值器
 */
public class UUIDFieldSetter extends FieldSetter<UUID> {
     ...
     * @param uuid  字段值
     */
    public UUIDFieldSetter(String field, UUID uuid) {
        super(field, uuid);
    }
     ...
     * @param uuid   字段值
     */
    public UUIDFieldSetter(String source, String field, UUID uuid) {
        super(source, field, uuid);
    }
     ...
     * @param uuid  字段值
     */
    public UUIDFieldSetter(Field field, UUID uuid) {
        super(field, uuid);
    }
    ...
    public String toString(EDataSource sourceType) {
        return this.field.toString(sourceType) + " = " + this.value.toString().toUpperCase() + "";
    }
    ...
    public String toString(ObjectReferencePack<DataParameter> parameters, EDataSource sourceType, IParameterCreator creator) {
        String valueStr = this.value.toString().toUpperCase();
