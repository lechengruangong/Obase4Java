 ...
 * 布尔字段设置器
 */
public class BoolFieldSetter extends FieldSetter<Boolean> {
     ...
     * @param aBoolean 字段值
     */
    public BoolFieldSetter(String field, Boolean aBoolean) {
        super(field, aBoolean);
    }
     ...
     * @param aBoolean 字段值
     */
    public BoolFieldSetter(String source, String field, Boolean aBoolean) {
        super(source, field, aBoolean);
    }
     ...
     * @param aBoolean 字段值
     */
    public BoolFieldSetter(Field field, Boolean aBoolean) {
        super(field, aBoolean);
    }
    ...
    public String toString(EDataSource sourceType) {
        return this.field.toString(sourceType) + "=" + (this.value ? "1" : "0");
    }
    ...
    public String toString(ObjectReferencePack<DataParameter> parameters, EDataSource sourceType, IParameterCreator creator) {
        String valueStr = this.value ? "1" : "0";
    ...
    protected String getParameters(ObjectReferencePack<DataParameter> parameters, EDataSource sourceType, Object valueStr,
        ...
        if (sourceType == EDataSource.PostgreSql && aNull) {
            parameters.realValue.Value = this.getValue();
        }
        return parameter;
    }
}
