 ...
 * 多租户string类型主键字段取值器
 */
public class MultiTenantStringFieldValueGetter implements IValueGetter {
     ...
     */
    public MultiTenantStringFieldValueGetter(Field fieldInfo, Class<?> targetType, Class<?> hostContextType) {
