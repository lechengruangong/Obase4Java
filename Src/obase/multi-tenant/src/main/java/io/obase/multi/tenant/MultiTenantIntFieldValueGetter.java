 ...
 * 多租户int类型主键字段取值器
 */
public class MultiTenantIntFieldValueGetter implements IValueGetter {
     ...
     */
    public MultiTenantIntFieldValueGetter(Field fieldInfo, Class<?> targetType, Class<?> hostContextType) {
