 ...
 * 逻辑删除的字段设值器
 */
public class LogicDeletionFieldValueSetter implements IValueSetter {
     ...
     * 逻辑删除的字段设值器
     *
     * @param fieldInfo  表示要设值的字段
     * @param targetType 目标的结构化类型
     */
    public LogicDeletionFieldValueSetter(Field fieldInfo, StructuralType targetType) {
    ...
    private void setValueCore(Field fieldInfo, Object obj, Object value) {
        ...
        try {
            ...
            throw new IllegalArgumentException("设置逻辑删除字段值失败.", e);
        }
    }
