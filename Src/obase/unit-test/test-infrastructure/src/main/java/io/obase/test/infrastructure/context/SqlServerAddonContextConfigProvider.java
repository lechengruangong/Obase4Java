...
import io.obase.providers.sqlserver.SqlServerContextConfigProvider;
...
public class SqlServerAddonContextConfigProvider extends SqlServerContextConfigProvider {
    /**
     * 使用指定的建模器创建对象数据模型
     *
