 ...
 * 红包的具体类型选择器
 */
public class RedEnvelopeConcreteTypeDiscriminator implements IConcreteTypeDiscriminator {
     ...
     */
    public RedEnvelopeConcreteTypeDiscriminator(Class<? extends ObjectContext> contextType) {
