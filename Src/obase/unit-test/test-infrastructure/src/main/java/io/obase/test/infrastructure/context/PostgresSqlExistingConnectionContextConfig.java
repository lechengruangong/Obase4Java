 ...
 */
public class PostgresSqlExistingConnectionContextConfig extends SqlContextConfigurator {
     ...
     */
    public PostgresSqlExistingConnectionContextConfig(ISqlExecutor sqlExecutor, boolean enableStructMapping) {
