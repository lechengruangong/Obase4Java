...
public class DefaultNewClass {
     ...
     * 班级任课老师
     */
    private List<DefaultNewClassTeacher> classTeachers;
     ...
     * @return 班级任课老师
     */
    public List<DefaultNewClassTeacher> getClassTeachers() {
     ...
     */
    public void setClassTeachers(List<DefaultNewClassTeacher> classTeachers) {
